...
<div class="modal fade" id="editproduk" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <?php echo form_open_multipart('home/edit_produk/anak')?>
        <div class="modal-body">
...
<div class="container mt-3" id="konten">
  <div class="text-center">
    <h1 style="font-size:2.5vmax;">Product Anak-Anak</h1>
  </div>
  <div class="row">
    <?php foreach($produk_anak as $value){?>
...
<script>
  ...
  function delete_produk(a){
      var href = "<?php echo base_url('index.php/home/hapus_produk/')?>"+a.id+"/anak";
      Swal.fire({
